...
if (!mute) { new MessageEmbed().setColor(inventory.Colors.NoEmbed).setDescription(`${message.author}, Lütfen muteyi atacağım kullanıcıyı belirt !`).setAuthor(message.member.tag, message.author.avatarURL({dynamic: true})).then(x => x.delete({timeout: 6500}));;
} else {
