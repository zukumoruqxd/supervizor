...
if (!mute) { new MessageEmbed().setColor(inventory.Colors.NoEmbed).setDescription(`${message.author}, Lütfen mute atacağım kullanıcıyı belirt!`).then(x => x.delete({timeout: 6500}));
} else {
